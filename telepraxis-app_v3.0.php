...
const TELEPRAXIS_APP_VERSION = '3.0';
...
<div class="topbar">
    <div class="topbar-row">
        <div class="topbar-title">telepraxis-app v<?= tp_h(TELEPRAXIS_APP_VERSION) ?> von Dr. Thomas Kienzle</div>
        ...
        <div class="menu-shell">
            ...
            <div class="menu-panel" id="header-menu" hidden>
                <div class="menu-section">
                    ...
                    <div class="menu-line">
                        <input type="text" id="workplace-input-menu" value="<?= tp_h($initialWorkplace) ?>" placeholder='z.B. "Julia" oder "anmeldung-links" oder "Dr. Meier"'>
...
<div class="app-shell">
    <div class="place-setup-row" id="place-setup-row" hidden>
        <div class="place-setup-inner">
            ...
            <input type="text" id="workplace-input-setup" value="<?= tp_h($initialWorkplace) ?>" placeholder='z.B. "Julia" oder "anmeldung-links" oder "Dr. Meier"'>

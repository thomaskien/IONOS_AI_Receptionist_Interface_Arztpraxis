#!/usr/bin/env bash
# zielserver-vorbereiten-v1.7.sh
#
# v1.7
...
main() {
  ...
  app_admin_password="$(ask_password_or_generate 'Supervisor/Adminpasswort fuer das Telepraxis-Webinterface')"
  sms_config_password="$(ask_password_or_generate 'Adminpasswort fuer sms-config.php')"
